...
; Constants
LUI_COUNTERS_BASE_X_POS		= $68
LUI_COUNTERS_BASE_Y_POS		= $5F
LUI_COUNTERS_ATTRIBUTES		= %00000001
LUI_LEVEL_TIMER_X_POS			= LUI_COUNTERS_BASE_X_POS
LUI_LEVEL_TIMER_Y_POS			= LUI_COUNTERS_BASE_Y_POS
LUI_ROOM_TIMER_X_POS			= LUI_COUNTERS_BASE_X_POS
LUI_ROOM_TIMER_Y_POS			= LUI_COUNTERS_BASE_Y_POS + $10
LUI_DROPPED_FRAMES_X_POS	= LUI_COUNTERS_BASE_X_POS + $20
LUI_DROPPED_FRAMES_Y_POS	= LUI_COUNTERS_BASE_Y_POS + $20
LUI_LEVEL_SELECT_HOLDOFF	= $09
LUI_LEVEL_SELECT_SPEED		= $02
